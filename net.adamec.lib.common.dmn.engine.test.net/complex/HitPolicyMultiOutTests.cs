...
namespace net.adamec.lib.common.dmn.engine.test.complex
{
    ...
    public class HitPolicyMultiOutTests
    {
        [TestMethod]
        ...
        public void UniqueHitPolicyMultiOutTest(int? a, int? b, string o1, int? o2, bool hasHit)
        {
            ...
            var file = Path.Combine(dir, "dmn/hitpolicy_MultiOut_Unique.dmn");
        ...
        {
            var dir = AppDomain.CurrentDomain.BaseDirectory;
            var file = Path.Combine(dir, "dmn/hitpolicy_MultiOut_First.dmn");
            var ctx = DmnExecutionContextFactory.CreateExecutionContext(DmnParser.Parse(file));
        ...
        {
            var dir = AppDomain.CurrentDomain.BaseDirectory;
            var file = Path.Combine(dir, "dmn/hitpolicy_MultiOut_Priority.dmn");
            var ctx = DmnExecutionContextFactory.CreateExecutionContext(DmnParser.Parse(file));
        ...
        {
            var dir = AppDomain.CurrentDomain.BaseDirectory;
            var file = Path.Combine(dir, "dmn/hitpolicy_MultiOut_Any.dmn");
            var ctx = DmnExecutionContextFactory.CreateExecutionContext(DmnParser.Parse(file));
        ...
        {
            var dir = AppDomain.CurrentDomain.BaseDirectory;
            var file = Path.Combine(dir, "dmn/hitpolicy_MultiOut_OutputOrder.dmn");
            var ctx = DmnExecutionContextFactory.CreateExecutionContext(DmnParser.Parse(file));
        ...
        {
            var dir = AppDomain.CurrentDomain.BaseDirectory;
            var file = Path.Combine(dir, "dmn/hitpolicy_MultiOut_RuleOrder.dmn");
            var ctx = DmnExecutionContextFactory.CreateExecutionContext(DmnParser.Parse(file));
